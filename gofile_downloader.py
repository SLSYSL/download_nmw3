...
class Manager:
    def __init__(self, url_or_file: str, password: str | None = None, root_dir: str | None = None) -> None:
        """
        Manager
        ...
        self._root_dir = (
            root_dir
            or getenv("GF_DOWNLOAD_DIR")
            or (path.dirname(sys.executable) if getattr(sys, 'frozen', False) else getcwd())
        )
